...
const getWeather = async(city) => {
    try {
        ...
        if (id < 300 && id > 200) {
            ...
            document.body.style.backgroundImage = "url('./photo/thu.jpg')";
        } else if (id < 400 && id > 300) {
            tempicon.src = "./icons/cloud-solid.svg"
            document.body.style.backgroundImage = "url('./photo/soli.jpg')";
            ...
            document.body.style.backgroundImage = "url('./photo/c.jpg')";
        } else if (id == 800) {
